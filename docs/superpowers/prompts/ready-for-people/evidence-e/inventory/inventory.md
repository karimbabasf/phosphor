...
| --- | --- | --- | --- | --- | --- | --- |
| `activity-link` | screens/receipts.js:394 | label (argument) | no | no | hover, focus, pending | 860: h 30 ok<br>400: h 30 ok |
...
| `btn btn-ghost` | screens/agent.js:563, screens/agent.js:926, screens/decision.js:632, screens/decision.js:657, screens/feedback.js:55, screens/feedback.js:149, screens/firstrun.js:341, screens/firstrun.js:666, screens/firstrun.js:668, screens/firstrun.js:844, screens/netpick.js:1118, screens/receipt.js:409, screens/receipt.js:598, screens/vault.js:161, screens/vault.js:166, screens/vault.js:167, screens/vault.js:775, screens/vault.js:851, screens/vault.js:922 | "Connect your own"; "Keep running"; "No"; "Cancel"; "Back"; "Copy"; "Print"; "Show the address"; "Check it again"; "Close"; "Restore from a phrase"; "Show my recovery words"; "Save an encrypted backup"; "Show the words again" | Refusing, Checking | no | hover, active, disabled, focus, pending | 860: h 36 ok<br>400: h 36 ok |
...
| `btn btn-ghost btn-sm` | screens/netpick.js:1202, screens/netpick.js:1315, screens/vault.js:670 | "Try again"; "Copy memo"; "Copy" | no | no | hover, active, disabled, focus, pending | 860: h 30 ok<br>400: h 30 ok |
...
| `checks-toggle` | screens/checks.js:199 | "Checks" | no | no | hover, focus, pending | 860: h 32 ok<br>400: h 32 ok |
| `chip` | screens/firstrun.js:901, screens/vault.js:215 | built by the caller; minutes (argument) | Saving | no | focus, pending | 860: h 30 ok<br>400: h 30 ok |
| `chip agent-retry` | screens/agent.js:520 | "Retry" | Starting | no | hover, focus, pending | 860: h 30 ok<br>400: h 30 ok |
| `chip chip-filter` | screens/receipts.js:124 | item.label (argument) | no | no | hover, focus, pending | 860: h 30 ok<br>400: h 30 ok |
| `chip connection-copy` | screens/agent.js:594 | "Copy" | no | no | focus, pending | 860: h 30 ok<br>400: h 30 ok |
| `chip suggest` | screens/agent.js:576 | SUGGESTIONS[s] (argument) | no | no | focus, pending | 860: h 32 ok<br>400: h 32 ok |
...
| `dock-close` | screens/deposit.js:267 | aria-label "Not now" | no | no | hover, focus, pending | 860: h 30 ok<br>400: h 30 ok |
| `dock-next` | screens/decision.js:605 | entry.queued (argument) | no | no | hover, focus, pending | 860: h 30 ok<br>400: h 30 ok |
| `dock-report-toggle` | screens/decision.js:958 | word (argument) | no | no | hover, focus, pending | 860: h 32 ok<br>400: h 32 ok |
| `fold-head card-head` | screens/basic.js:194 | title (argument) | no | no | hover, focus, pending, on | 860: h 52 ok<br>400: h 52 ok |
| `holding-head` | screens/pro.js:378 | built by the caller | no | no | hover, focus, pending, on | 860: h 53 ok<br>400: h 53 ok |
| `jump-latest` | screens/agent.js:636 | "Jump to latest" | no | no | hover, focus, pending | 860: h 32 ok<br>400: h 32 ok |
...
| `lock-eye` | screens/lock.js:240 | aria-label "Show password" | no | no | hover, focus, pending, on | 860: h 36 ok<br>400: h 36 ok |
| `net-row` | screens/netpick.js:868 | n.name (argument) | no | no | hover, focus, pending, on | 860: h 52 ok<br>400: h 52 ok |
| `net-tile` | screens/netpick.js:736 | n.name (argument) | no | no | hover, active, focus, pending, on | 860: h 84 ok<br>400: h 84 ok |
| `netpick-back` | screens/netpick.js:920 | "Change network" | no | no | hover, focus, pending | 860: h 30 ok<br>400: h 30 ok |
| `netpick-link` | screens/netpick.js:778, screens/netpick.js:1356 | built by the caller; " " | no | no | hover, focus, pending | 860: h 30 ok<br>400: h 30 ok |
| `netsel` | screens/vault.js:472 | aria-label "Which network" | no | no | hover, focus, pending, on | 860: h 40 ok<br>400: h 40 ok |
| `pane-hide` | split.js:473 | aria-label "Hide the " | no | no | hover, focus, pending | 860: h 30 ok<br>400: h 30 ok |
| `pane-show` | split.js:496 | aria-label "Show the " | no | no | hover, focus, pending | 860: h 30 ok<br>400: h 30 ok |
| `receipt-close` | screens/receipt.js:345 | aria-label "Close" | no | no | hover, focus, pending | 860: h 32 ok<br>400: h 32 ok |
| `rule-group-title opens` | screens/pro.js:979 | title (argument) | no | no | hover, active, focus, pending, on | 860: h 30 ok<br>400: h 30 ok |
| `sendcard-info` | screens/sendcard.js:247 | "i" | no | no | hover, focus, pending | 860: h 30 ok<br>400: h 30 ok |
| `status-line bar-state` | index.html:71 | "Not backed up" | no | no | focus, pending | 860: h 30 ok<br>400: h 30 ok |
| `steps-fold` | screens/agent.js:1559 | icon chevron | no | no | hover, focus, pending, on | 860: h 30 ok<br>400: h 30 ok |
...
| `trade-tab` | screens/trade.js:357 | TABS (argument) | no | no | hover, focus, pending, on | 860: h 35 ok<br>400: h 35 ok |
| `tx receipt-row` | screens/receipt.js:669 | "" | no | no | hover, focus, pending | 860: h 66 ok<br>400: h 86 ok |
