...
export const RECIPES: readonly Recipe[] = [
  ...
  { family: 'btn btn-ghost btn-sm tcard-open', wrap: 'tcard-actions', children: [label('Open in Add money')] },
  { family: 'btn btn-quiet btn-sm tcard-show-qr', wrap: 'tcard-actions', children: [label('Show QR code')] },
  { family: 'btn btn-ghost btn-sm trade-more', children: [label('More')] },
  { family: 'btn btn-ghost btn-sm trade-act', wrap: 'trade-row-foot', children: [label('Close')] },
  { family: 'btn btn-quiet btn-sm trade-confirm-keep', wrap: 'trade-confirm-actions', children: [label('Keep it open')], disables: true },
  { family: 'btn btn-sm trade-confirm-go', wrap: 'trade-confirm-actions', children: [label('Close now')], disables: true },
  ...
  { family: 'bal-add', wrap: 'bal-actions', children: [{ tag: 'svg', icon: 'deposit', cls: 'icon' }, { tag: 'span', text: 'Add money' }], labelSelector: 'span' },
  { family: 'chip threshold-chip num', wrap: 'threshold-chips', attrs: { role: 'radio', 'aria-checked': 'false' }, children: [{ tag: 'span', text: '$100' }], on: { 'aria-checked': 'true' }, labelSelector: 'span' },
  { family: 'vault-chip num', wrap: 'vault-chips', attrs: { role: 'radio', 'aria-checked': 'false' }, children: [{ tag: 'span', text: '$100' }], on: { 'aria-checked': 'true' }, labelSelector: 'span' },
