...
export const RECIPES: readonly Recipe[] = [
  ...
  { family: 'btn btn-primary btn-sm', wrap: 'agent-controls', children: [label('Start your assistant')], pending: 'Starting', disables: true },
  { family: 'btn btn-primary lock-unlock', wrap: 'lock-card', children: [label('Unlock')], pending: 'Unlocking', disables: true },
  { family: 'btn btn-ghost', children: [label('No')], pending: 'Refusing', disables: true },
  ...
  { family: 'btn btn-danger', children: [label('Turn off')] },
  { family: 'btn', children: [label('Got it')], pending: 'Filing', disables: true },
  { family: 'btn btn-sm freeze', wrap: 'status-cluster', children: [label('Freeze everything')], pending: 'Freezing', disables: true },
  ...
  { family: 'chip agent-retry', wrap: 'agent-note', children: [label('Retry')], pending: 'Starting', disables: true },
  ...
  { family: 'jump-latest', wide: true, wrap: 'conversation-body', wrapStyle: 'position: relative; height: 40px', attrs: { 'data-on': 'true' }, children: [label('Jump to latest'), { tag: 'svg', icon: 'chevron-down', cls: 'icon jump-glyph' }, { tag: 'span', cls: 'jump-count mono', text: '3' }] },
  ...
  { family: 'layout opens', wrap: 'status-cluster', attrs: { 'aria-haspopup': 'menu', 'aria-expanded': 'false' }, children: [{ tag: 'svg', icon: 'layout', cls: 'icon' }, { tag: 'span', text: 'Layout' }], on: { 'aria-expanded': 'true' }, labelSelector: 'span' },
  { family: 'status-line bar-state', wrap: 'status-cluster', attrs: { 'data-tone': 'warn' }, children: [{ tag: 'span', cls: 'status-dot' }, { tag: 'span', text: 'Not backed up' }], labelSelector: 'span:last-child' },
  ...
  { family: 'fold-head card-head', wide: true, wrap: 'fold card', attrs: { 'aria-expanded': 'false' }, children: [{ tag: 'span', cls: 'card-title', text: 'Activity' }, { tag: 'span', cls: 'fold-head-right', children: [{ tag: 'span', cls: 'card-meta', text: '4 today' }, { tag: 'span', cls: 'fold-mark' }] }], on: { 'aria-expanded': 'true' }, labelSelector: '.card-title' },
  ...
  { family: 'dock-next', wide: true, wrap: 'dock-body', children: [{ tag: 'span', text: '1 more waiting, next' }, { tag: 'span', cls: 'chev' }], labelSelector: 'span:first-child' },
  { family: 'dock-report-toggle', wide: true, wrap: 'dock-report', children: [{ tag: 'span', cls: 'dock-report-word', text: 'What the rail said' }, { tag: 'span', cls: 'dock-report-count', text: '3 lines' }, { tag: 'span', cls: 'dock-report-chevron' }], on: { 'aria-expanded': 'true' }, labelSelector: '.dock-report-word' },
  ...
  { family: 'agent-tile', wide: true, wrap: 'agentpick-grid', attrs: { 'data-agent': 'claude-code', style: '--net: #d97757' }, children: [{ tag: 'span', cls: 'agent-tile-mark', text: 'C' }, { tag: 'span', cls: 'agent-tile-name', text: 'Claude Code' }], on: { 'aria-current': 'true' }, labelSelector: '.agent-tile-name' },
  ...
  { family: 'holding-head', wide: true, wrap: 'holding', children: [{ tag: 'span', cls: 'holding-mark' }, { tag: 'div', cls: 'holding-name', children: [{ tag: 'span', cls: 'holding-symbol', text: 'USDC' }, { tag: 'span', cls: 'holding-where', text: 'in your account' }] }, { tag: 'div', cls: 'holding-figures', children: [{ tag: 'span', cls: 'holding-value mono', text: '$3,766.45' }] }], on: { 'aria-expanded': 'true' }, labelSelector: '.holding-symbol' },
  { family: 'rule-group-title opens', wide: true, wrap: 'card', attrs: { 'aria-expanded': 'false' }, children: [{ tag: 'span', cls: 'rule-group-name', text: 'Sending' }, { tag: 'span', cls: 'rule-group-count mono', text: '3' }, { tag: 'span', cls: 'chev', children: [{ tag: 'svg', icon: 'chevron-down', cls: 'icon' }] }], on: { 'aria-expanded': 'true' }, labelSelector: '.rule-group-name' },
