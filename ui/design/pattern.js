...
(function () {
  ...
  var FRAG = [
    ...
    /* Mixed toward the ink rather than added to the ground. On graphite the two
       are the same picture to within a rounding, and a mix still reads if an
       agent ever sets a light ground: adding a dark ink to white paints
       nothing, mixing toward it darkens the ground by the same tenth the glow
       lightens it on black, so the pulse reads on every ground. */
