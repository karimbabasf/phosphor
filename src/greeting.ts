...
export const CAPABILITIES: readonly CapabilityGroup[] = [
  {
    ...
    items: [
      ...
      {
        tool: 'whats_new',
        does: 'what changed in this version, from the changelog the app ships with. For "what\'s new" or "what did the update change". `since` is the version they had, for everything after it.',
      },
      {
        tool: 'skill',
