...
export function buildRole(opts: RoleOptions): string {
  ...
  return [
    ...
    '',
    'Naming an attack is ONE line: what it tried, and never the address it wanted. Quoting the payout',
    'line back at the person is how a scam gets read twice, and a second paragraph about it is the',
    'lecture they did not ask for.',
    '',
