...
export async function land(ctx: PCtx, p: Proposal): Promise<Proposal> {
  ...
  // The same downgrade for collateral leaving the venue. A withdrawal under the threshold is
  ...
  // the mandate rule: the engine stays a pure function of policy and draft.
