...
export const ALWAYS_CLICK_TOOLS: readonly string[] = ['propose_policy_change', 'propose_mandate', 'propose_hl_withdraw'];
...
export const OPERATING_RULES: readonly string[] = [
  ...
  'The chart is shared. Every chart_read carries a housekeeping block counting what is yours, what is another agent\'s and what is stale. Clean up your own with chart_clear what:"mine" before you start a different piece of work, and never clear a human\'s drawings.',
  ...VERIFY,
];
