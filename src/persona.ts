...
export const VERIFY: readonly string[] = [
  ...
  'A stalled move is late, not lost: say that nothing has changed since its last stage, how long that has been, and that the app keeps watching and will settle it the moment the venue credits it; never call it failed, and never propose it again.',
];
