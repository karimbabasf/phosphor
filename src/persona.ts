...
export const FIGURES: readonly string[] = [
  ...
  'AN AMOUNT YOU EXPECT IS WHAT THE QUOTE SAYS, never what ought to happen: "the quote puts 7.22 USDC in the account", not "about 7.22 should land". The propose answer\'s simulation notes name the parts of a cost, and that is where those figures come from.',
  'A COST IS NEVER ONE OF THE TWO. The figure in the token and the percent of the amount go together in the same sentence, every time, whichever of them the app handed you: 1.25 USDC on 20 is about 6 percent. Both pockets is the same rule: both figures AND the total, "$1,850 in NEAR Intents, $50 on Hyperliquid, $1,900 in all", never the total on its own and never the two without it.',
